...
> 🧭 **Başlangıç pusulası:** Doplama, silikonu "kirletmek" değil, elektriğin hangi yönde akacağını tasarlamaktır. Eklenen atom sayısı çok azdır ama etkisi devdir çünkü yük taşıyıcılarının davranışını değiştirir.

![Diagram: Saf silikon ile katkılanmış silikonun atomik farkı](images/day-06/pure-vs-doped-silicon.svg)

*Şema/TODO: Saf Si kafesi ile fosfor/bor eklenmiş kafesi yan yana; fazla elektron ve delik basit ikonlarla gösterilsin.*
...
> 🧠 **Kısa ezber kuralı:** Fosfor = bir elektron fazla = n-tipi. Bor = bir bağ eksik = delik = p-tipi. Baştaki atom fiziği karmaşık görünse de üretimde sürekli bu iki mantığa dönersiniz.

![Diagram: Fosforun fazla elektron, borun delik oluşturması](images/day-06/phosphorus-boron-doping.svg)

*Şema/TODO: Fosfor ve bor için iki küçük atom şeması; fazla elektron ve eksik bağ açıkça etiketlensin.*
...
![Diagram: P-N eklemi, tükenme bölgesi ve alan yönü](images/day-06/pn-junction-depletion-region.svg)

*Şema/TODO: p-tipi taban, n-tipi yayıcı, sabit iyonlar, elektrik alan oku ve elektron/delik ayrımı etiketlensin.*
...
> 🔎 **Pratik çerçeve:** Burada amaç bütün levhayı baştan sona fosforla doldurmak değil; yalnızca yüzeye çok ince bir n-tipi katman eklemek. Asıl hücre kalınlığının neredeyse tamamı hâlâ taban malzemedir.

![Diagram: POCl₃ difüzyon fırını ve ince yayıcı oluşumu](images/day-06/pocl3-diffusion-furnace.svg)

*Şema/TODO: Kuvars tüp, dik duran levhalar, gaz akışı, yüzeyde PSG ve altındaki yayıcı katmanı gösterilsin.*
