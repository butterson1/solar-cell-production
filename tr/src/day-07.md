...
![Diagram: Düz silikon yüzeyde yansıma ve kaplamalı/dokulu yüzeyde ışık girişi](images/day-07/reflection-vs-trapping.svg)
...
![Diagram: Çeyrek dalga kaplamada yıkıcı girişim](images/day-07/quarter-wave-interference.svg)
...
![Diagram: Piramit dokuda çoklu sıçrama ile ışık yakalama](images/day-07/pyramid-texture-light-bounce.svg)
...
![Photo placeholder: Siyah silikon yüzey ile klasik piramit dokunun yakın plan karşılaştırması](images/day-07/black-silicon-vs-pyramids.svg)
